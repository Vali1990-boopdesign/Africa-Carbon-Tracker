...
function _2(Plot,counties,unemployment,statemap,states){return(
Plot.plot({
  width: 975,
  height: 610,
  projection: "identity",
...
new Map((await FileAttachment("unemployment-x.csv").csv()).map(d => [d.id, +d.rate]))
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["unemployment-x.csv", {url: new URL("./files/1620fc155f28822d9d68088ea0cccf54bbe9feb8d8c82115d496e5796d4b093bf27cd6ae93ae7241a2a481a29180d382f63fd41194cec619761704f56599e94a.csv", import.meta.url), mimeType: "text/csv", toString}],
  ...
  main.variable(observer()).define(["Plot","counties","unemployment","statemap","states"], _2);
