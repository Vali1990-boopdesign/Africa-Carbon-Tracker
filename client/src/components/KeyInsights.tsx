...
export function KeyInsights({ isLoading }: KeyInsightsProps) {
  ...
  return (
    ...
    >
      <Card className="glass-effect bg-white/95 dark:bg-gray-900/95 h-40 relative overflow-hidden bg-gradient-to-r from-emerald-500/10 via-blue-500/10 to-purple-500/10 border-2 border-transparent bg-clip-padding rounded-lg" 
        style={{
