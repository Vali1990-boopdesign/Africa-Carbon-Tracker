  ...
  return (
    <TooltipProvider>
      <Tooltip>
        ...
        <TooltipContent className="max-w-xs bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg z-[100]" side="bottom" align="center" sideOffset={8}>
