  ...
  return (
    <TooltipProvider>
      <Tooltip>
        ...
        <TooltipContent className="max-w-xs bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg z-50" side="top" align="center" sideOffset={8}>
