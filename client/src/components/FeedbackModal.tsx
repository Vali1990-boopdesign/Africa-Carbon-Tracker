          ...
          <div className="py-8">
            ...
            >
              ...
              <p className="text-gray-400 max-w-md">
                ...
                and user experience. We review all feedback monthly and use it to inform
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-gray-400">
                Share your experience with the Africa Carbon Dashboard
              </DialogDescription>
            </DialogHeader>
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      {[
                        ...
                        <div
                          key={option.value}
                          className="flex items-center space-x-3 p-3 rounded-lg border border-gray-700 hover:border-emerald-500/50 bg-gray-800/50 transition-colors"
                        >
                          <RadioGroupItem value={option.value} id={option.value} data-testid={`radio-${option.value}`} />
                          <Label
                            htmlFor={option.value}
                            className="text-white cursor-pointer flex-1 font-normal"
                          >
                            {option.label}
                          </Label>
                        </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4 p-4 bg-gray-800/50 rounded-lg border border-gray-700">
                      <div className="flex items-start space-x-3">
                        ...
                        <Label
                          htmlFor="follow-up"
                          className="text-white cursor-pointer font-normal leading-relaxed"
                        >
                          I'm open to a 10-minute follow-up conversation about my feedback
                        </Label>
                      </div>
                      ...
                      {formData.q4_follow_up && (
                        ...
                        >
                          ...
                          {/* Privacy Consent */}
                          <div className="flex items-start space-x-3 p-3 bg-gray-900/50 rounded border border-gray-600">
                            <Checkbox
                              id="privacy-consent"
                            ...
                            <Label
                              ...
                              className="text-xs text-gray-400 cursor-pointer font-normal leading-relaxed"
                            >
                              I consent to BFA Global storing my email address for the purpose of
                              follow-up conversation about this feedback. Your email will not be
                              used for marketing purposes and will be handled in accordance with
                              our privacy policy.
                            </Label>
                          </div>
                        </motion.div>
