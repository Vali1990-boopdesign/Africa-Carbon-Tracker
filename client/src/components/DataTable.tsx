...
export function DataTable({ transactions, isLoading, onProjectTypeClick }: DataTableProps) {
  ...
  const getProjectTypeColor = (type: string) => {
    switch (type.toLowerCase()) {
      case "afforestation":
      case "forestry":
        return "bg-[hsl(var(--color-forestry-bg))] text-[hsl(var(--color-forestry))] hover:opacity-80";
      case "solar":
      case "renewable energy":
        return "bg-[hsl(var(--color-renewable-bg))] text-[hsl(var(--color-renewable))] hover:opacity-80";
      case "methane capture":
      case "waste management":
        return "bg-[hsl(var(--color-waste-bg))] text-[hsl(var(--color-waste))] hover:opacity-80";
      default:
        return "bg-[hsl(var(--color-default-bg))] text-[hsl(var(--color-default))] hover:opacity-80";
    }
  };
